...
for event in all_events:
    ...
    if event["type"] == "deposit":
        ...
        # Apply the deposit to cash balances
        # (Assuming initial deposits went into USD/EUR balances matching your setup)
        if date_str in ["2024-08-11", "2024-08-16", "2025-02-14", "2026-06-03"]:
            # These are your logged USD source deposits
            pass # Script adds to cash tracking dynamically
        running_eur_cash += event['data']['amount_eur']
